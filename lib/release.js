...
function versionBump(type, cb) {
	...
	if (!isValidType) {
		...
		if (!teamcity.isCiRun()) {
			console.log('[WARN] Not under TeamCity. If you want to have tag, create it manually');
		} else {
			console.log('[INFO] If build configuration setup correctly, tag should be created automatically')
		}
